...
# message(df_info$tbeg,df_info$tend,df_info$dataname,df_info$timename,df_info$statename)
        ...
        else if(input$navROOUP == "RORegimeOUP")
        {
          ...
          # initialize ----
          FromR6toUI()
          # observe undn, unup, sync, axes, plot, left and rght ----
          undnButton <- reactiveVal(FALSE)
          unupButton <- reactiveVal(FALSE)
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnRORegimeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupRORegimeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$syncRORegimeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(FALSE)
          ...
          }) %>% bindEvent(input$undnRORegimeOUP,input$unupRORegimeOUP,input$syncRORegimeOUP,input$axesRORegimeOUP,input$plotRORegimeOUP,input$leftRORegimeOUP,input$rghtRORegimeOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navROOUP == "RODecisionOUP")
        {
          ...
          # observe undn, unup, sync, axes, plot ----
          undnButton <- reactiveVal(FALSE)
          unupButton <- reactiveVal(FALSE)
          syncButton <- reactiveVal(FALSE)
          axesButton <- reactiveVal(FALSE)
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnRODecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupRODecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navROOUP == "ROPassageTimeOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnROPassageTimeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupROPassageTimeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
    ...
    else if(input$navBar == "tabAOUP")
    {
      observeEvent(input$navAOUP,{
        ...
        if(input$navAOUP == "ADriftOUP")
        {
          ...
          # initialize ----
          FromR6toUI()
          # observe undn, unup, sync, axes and plot ----
          undnButton <- reactiveVal(FALSE)
          unupButton <- reactiveVal(FALSE)
          syncButton <- reactiveVal(FALSE)
          axesButton <- reactiveVal(FALSE)
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnADriftOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupADriftOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "ADiffusionOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnADiffusionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupADiffusionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          output$plotlyADiffusionOUP <- renderPlotly({
            ...
            FromR6toUI()
            A$PlotDiffusion()
          }) %>% bindEvent(input$undnADiffusionOUP,input$unupADiffusionOUP,input$syncADiffusionOUP,input$axesADiffusionOUP,input$plotADiffusionOUP,input$leftADiffusionOUP,input$rghtADiffusionOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "AMeanOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAMeanOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAMeanOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "AMeanCOUP")
        {
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnAMeanCOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupAMeanCOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAMeanCOUP,input$unupAMeanCOUP,input$syncAMeanCOUP,input$axesAMeanCOUP,input$plotAMeanCOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "AVarianceOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAVarianceOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAVarianceOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "AVarianceCOUP")
        {
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnAVarianceCOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupAVarianceCOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAVarianceCOUP,input$unupAVarianceCOUP,input$syncAVarianceCOUP,input$axesAVarianceCOUP,input$plotAVarianceCOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "ADensityOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnADensityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
           observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupADensityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
         observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          output$plotlyADensityOUP <- renderPlotly({
            ...
            FromR6toUI()
            A$PlotDensity()
          }) %>% bindEvent(input$undnADensityOUP,input$unupADensityOUP,input$syncADensityOUP,input$axesADensityOUP,input$plotADensityOUP,input$leftADensityOUP,input$rghtADensityOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "AProbabilityOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAProbabilityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAProbabilityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          output$plotlyAProbabilityOUP <- renderPlotly({
            ...
            FromR6toUI()
            A$PlotProbability()
          }) %>% bindEvent(input$undnAProbabilityOUP,input$unupAProbabilityOUP,input$syncAProbabilityOUP,input$axesAProbabilityOUP,input$plotAProbabilityOUP,input$leftAProbabilityOUP,input$rghtAProbabilityOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "ADoubleOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnADoubleOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupADoubleOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnADoubleOUP,input$unupADoubleOUP,input$syncADoubleOUP,input$axesADoubleOUP,input$plotADoubleOUP,input$leftADoubleOUP,input$rghtADoubleOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "AOptionOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAOptionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAOptionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          output$plotlyAOptionOUP <- renderPlotly({
            ...
            FromR6toUI()
            A$PlotOption()
          }) %>% bindEvent(input$undnAOptionOUP,input$unupAOptionOUP,input$syncAOptionOUP,input$axesAOptionOUP,input$plotAOptionOUP,input$leftAOptionOUP,input$rghtAOptionOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "AEnvelopeOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAEnvelopeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAEnvelopeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAEnvelopeOUP,input$unupAEnvelopeOUP,input$syncAEnvelopeOUP,input$axesAEnvelopeOUP,input$plotAEnvelopeOUP,input$leftAEnvelopeOUP,input$rghtAEnvelopeOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "ADecisionOUP")
        {
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnADecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupADecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "AObligationOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAObligationOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAObligationOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          output$plotlyAObligationOUP <- renderPlotly({
            ...
            FromR6toUI()
            A$PlotObligation()
          }) %>% bindEvent(input$undnAObligationOUP,input$unupAObligationOUP,input$syncAObligationOUP,input$axesAObligationOUP,input$plotAObligationOUP,input$leftAObligationOUP,input$rghtAObligationOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "APTModeMedianMeanOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAPTModeMedianMeanOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAPTModeMedianMeanOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "APTVarianceOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAPTVarianceOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAPTVarianceOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAPTVarianceOUP,input$unupAPTVarianceOUP,input$syncAPTVarianceOUP,input$axesAPTVarianceOUP,input$plotAPTVarianceOUP,input$leftAPTVarianceOUP,input$rghtAPTVarianceOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "APTPercentilesOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAPTPercentilesOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAPTPercentilesOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
        ...
        else if(input$navAOUP == "APTDensityOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAPTDensityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAPTDensityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAPTDensityOUP,input$unupAPTDensityOUP,input$syncAPTDensityOUP,input$axesAPTDensityOUP,input$plotAPTDensityOUP,input$leftAPTDensityOUP,input$rghtAPTDensityOUP)
          # user clicks info ----
          observe({
            ibutton("")
        ...
        else if(input$navAOUP == "APTProbabilityOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnAPTProbabilityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            syncButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupAPTProbabilityOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            syncButton(TRUE)
          ...
          }) %>% bindEvent(input$undnAPTProbabilityOUP,input$unupAPTProbabilityOUP,input$syncAPTProbabilityOUP,input$axesAPTProbabilityOUP,input$plotAPTProbabilityOUP,input$leftAPTProbabilityOUP,input$rghtAPTProbabilityOUP)
          # observe info ----
          observe({
            ibutton("")
    ...
    else if(input$navBar == "tabFDOUP")
    {
      observeEvent(input$navFDOUP,{
        ...
        if(input$navFDOUP == "FDDriftOUP")
        {
          ...
          # initialize ----
          FromR6toUI()
          # observe undn, unup, axes and plot ----
          undnButton <- reactiveVal(FALSE)
          unupButton <- reactiveVal(FALSE)
          axesButton <- reactiveVal(FALSE)
          plotButton <- reactiveVal(FALSE)
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnFDDriftOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupFDDriftOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
        ...
        if(input$navFDOUP == "FDDiffusionOUP")
        {
          ...
          # initialize ----
          FromR6toUI()
          # observe undn, unup, axes, plot, left and rght ----
          undnButton <- reactiveVal(FALSE)
          unupButton <- reactiveVal(FALSE)
          axesButton <- reactiveVal(FALSE)
          plotButton <- reactiveVal(FALSE)
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnFDDiffusionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupFDDiffusionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
          ...
          output$plotlyFDDiffusionOUP <- renderPlotly({
            ...
            FromR6toUI()
            FD$PlotDiffusion()
          }) %>% bindEvent(input$undnFDDiffusionOUP,input$unupFDDiffusionOUP,input$axesFDDiffusionOUP,input$plotFDDiffusionOUP,input$leftFDDiffusionOUP,input$rghtFDDiffusionOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        if(input$navFDOUP == "FDTerminalOUP")
        {
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnFDTerminalOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupFDTerminalOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
        ...
        if(input$navFDOUP == "FDOptionOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnFDOptionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupFDOptionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
          ...
          output$plotlyFDOptionOUP <- renderPlotly({
            ...
            FromR6toUI()
            FD$PlotOption()
          }) %>% bindEvent(input$undnFDOptionOUP,input$unupFDOptionOUP,input$axesFDOptionOUP,input$plotFDOptionOUP,input$leftFDOptionOUP,input$rghtFDOptionOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        if(input$navFDOUP == "FDEnvelopeOUP")
        {
          ...
          observe({
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$undnFDEnvelopeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            ...
            leftButton(FALSE)
            rghtButton(FALSE)
          }) %>% bindEvent(input$unupFDEnvelopeOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
          ...
          }) %>% bindEvent(input$undnFDEnvelopeOUP,input$unupFDEnvelopeOUP,input$axesFDEnvelopeOUP,input$plotFDEnvelopeOUP,input$leftFDEnvelopeOUP,input$rghtFDEnvelopeOUP)
          # observe info ----
          observe({
            ibutton("")
        ...
        if(input$navFDOUP == "FDDecisionOUP")
        {
          ...
          observe({
            ...
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$undnFDDecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(TRUE)
            axesButton(FALSE)
            plotButton(FALSE)
          }) %>% bindEvent(input$unupFDDecisionOUP,ignoreNULL=TRUE,ignoreInit=TRUE)
          observe({
            undnButton(FALSE)
            unupButton(FALSE)
            axesButton(TRUE)
